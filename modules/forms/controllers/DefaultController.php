    ...
    public function actionOneClick() {
        ...
        if (Yii::$app->request->isAjax) {
            ...
            if ($model->load(Yii::$app->request->post())) {
                ...
                $model->body = $model->name . "<a href= \"tel:$model->phone\">$model->phone</a>". ' заказал:'  . "<br>" . $model->good . ' (' . $model->count . ' шт) ' . "<br>";
                $model->body .= "<img src=\"$model->image\" height=\"100px\" alt=\"$model->good\">" . "<br>";
