...
class XmlResponseFormatter extends \yii\base\Component implements \yii\web\ResponseFormatterInterface {
    ...
    public function format($response) {
        ...
        if ($response->data !== null) {
            ...
            if (!empty($this->rootTag)) {
                ...
                if ($this->rootTag == 'realty-feed' && $this->target == 'yandex')
        ...
        if (is_array($data) ||
            ...
            foreach ($data as $name => $value) {
                if (is_int($name) && is_object($value)) {
                    ...
                    // Internal ID Yandex
                    if ($this->getValidXmlElementName($name) == 'item' || 'offer' || 'realty-feed') {

                        if (isset($value['id']))
                            $child->setAttribute('internal-id', $value['id']);
                    }
...
//                    print_r($child);
                    if ($name == 'id' && $this->target == 'yandex') {

                        /*
                         *   ID не нужен  дядя вова
                         */
                    } else {
                        $element->appendChild($child);
